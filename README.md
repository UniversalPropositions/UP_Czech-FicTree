...
- `git clone https://github.com/UniversalPropositions/UP_Czech-FicTree.git`
...
- `python3 up2/merge_ud_up.py --input_ud=<ud_path_to_UD_Czech-FicTree>/ --input_up=<up_path_to_UP_Czech-FicTree>/ --output=<path_to_UD+UP_Czech-FicTree>/`
